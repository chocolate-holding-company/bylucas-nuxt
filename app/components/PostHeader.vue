<template>
 <transition name="fade" mode="out-in">
  <header
   id="post-header"
   class="relative h-[50vh] min-h-105 flex items-end overflow-hidden bg-black"
  >
   <img
    id="header-image"
    :src="post.image"
   ...
   <div class="relative z-10 pb-16 max-w-5xl mx-auto px-4 sm:px-8 text-white">
    <span
     id="post-category"
    ...
    <p id="post-summary" class="text-gray-200 text-lead-fluid mb-8 font-medium">
     {{ post.description }}
    </p>
    <div class="text-sm font-medium border-l-4 border-rose-800 pl-4">
     <div class="ml-auto">
      <p class="text-gray-200 uppercase text-[10px] font-black tracking-widest">
       Published
      </p>
